...
const conexion = require("../database/db") // Corregido: cambiado de './database/db' a '../database/db'
const reparacionController = require("../controllers/reparacionController") // Corregido: cambiado de './controllers/reparacionController' a '../controllers/reparacionController'
